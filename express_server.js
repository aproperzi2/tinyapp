...
app.get("/urls/:shortURL", (req, res) => {
  const templateVars = { user_email: req.cookies['user_email'], user_id: req.cookies['user_id'], shortURL: req.params.shortURL, longURL: urlDatabase[req.params.shortURL].longURL };
